...
describe('BalanceController (e2e)', () => {
  ...
  describe('POST /auth/balance/deposit', () => {
    ...
    it('should increase balance after deposit', async () => {
      ...
      const balanceResponse = await appHelper
        .getRequest()
        .get('/auth/balance')
        .set('Authorization', `Bearer ${accessToken}`);
    ...
    it('should return 400 when userId is not a valid UUID', async () => {
      ...
      const response = await appHelper
        ...
        .post('/auth/balance/deposit')
        .set('Authorization', `Bearer ${accessToken}`)
        .send({ userId: 'invalid-uuid', amount: 500 });
    ...
    it('should return 401 when no token is provided', async () => {
      const response = await appHelper
        .getRequest()
        .post('/auth/balance/deposit')
        .send({ userId: '00000000-0000-0000-0000-000000000000', amount: 500 });
  ...
  describe('POST /auth/balance/reserve', () => {
    ...
    it('should return 400 when bookingId is not a valid UUID', async () => {
      ...
      const response = await appHelper
        ...
        .post('/auth/balance/reserve')
        .set('Authorization', `Bearer ${accessToken}`)
        .send({ userId, bookingId: 'invalid-uuid', amount: 100 });
  ...
  describe('GET /auth/transactions', () => {
    ...
    it('should support pagination', async () => {
      ...
      const response = await appHelper
        .getRequest()
        .get('/auth/transactions?page=1&limit=1')
        .set('Authorization', `Bearer ${accessToken}`);
    ...
    it('should return 401 when no token is provided', async () => {
      const response = await appHelper.getRequest().get('/auth/transactions');
  ...
  describe('Full flow test', () => {
    it('should complete full balance flow: deposit → reserve → release', async () => {
      ...
      const balanceResponse1 = await appHelper
        .getRequest()
        .get('/auth/balance')
        .set('Authorization', `Bearer ${accessToken}`);
      ...
      const balanceResponse2 = await appHelper
        .getRequest()
        .get('/auth/balance')
        .set('Authorization', `Bearer ${accessToken}`);
      ...
      const response3 = await appHelper
        .getRequest()
        .post('/auth/balance/release')
        .set('Authorization', `Bearer ${accessToken}`)
        .send({
      ...
      const balanceResponse3 = await appHelper
        .getRequest()
        .get('/auth/balance')
        .set('Authorization', `Bearer ${accessToken}`);
      ...
      const transactionsResponse = await appHelper
        .getRequest()
        .get('/auth/transactions')
        .set('Authorization', `Bearer ${accessToken}`);
