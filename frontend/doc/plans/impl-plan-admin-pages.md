...
- Метрики: активные клиенты, тренировок на неделе, загрузка залов, средняя заполняемость
...
┌─────────────────────────────────────────────────────────────────────────────┐
│ ┌──────────────────┐ ┌──────────────────┐ ┌──────────────────┐ ┌──────────────────┐ │
│ │ Активные клиенты │ │ Тренировок       │ │ Загрузка залов   │ │ Средняя заполн.  │ │
│ │      156         │ │      42          │ │      78%         │ │      65%         │ │
│ │   ↑ 12%          │ │   ↑ 5            │ │   ↓ 3%           │ │   ↑ 8%           │ │
│ └──────────────────┘ └──────────────────┘ └──────────────────┘ └──────────────────┘ │
└─────────────────────────────────────────────────────────────────────────────┘
...
- Колонки: Название, Тип, Тренер, Дата/Время, Места, Статус, Действия
...
├─────────────────────────────────────────────────────────────────────────────┤
│ Название    │ Тип     │ Тренер        │ Дата       │ Места │ Статус │ Действия │
├─────────────┼─────────┼───────────────┼────────────┼───────┼────────┼──────────┤
│ Morning Yoga│ yoga    │ Анна Иванова  │ 15 янв 10:00│ 5/20 │ 🟢     │ [👥][✏️][🗑️] │
│ CrossFit    │ crossfit│ Михаил Петров │ 15 янв 18:00│ 20/20│ 🟡     │ [👥][✏️][🗑️] │
...
| -------------------------------------------------- | ----------- | ------- | --------------------------------------- |
| Отсутствие API для Users                           | Высокая     | Среднее | Добавить endpoints в backend или моки   |
...
1. **Backend API для Users** — текущий backend не имеет endpoints для списка пользователей и их блокировки. Требуется либо добавить эти endpoints, либо использовать моковые данные для демонстрации.
