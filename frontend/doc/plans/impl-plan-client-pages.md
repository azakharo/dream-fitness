...
- Отображение тренировок в каждой ячейке дня
- Если тренировок > 3, показываются первые 3 по времени + кнопка "Ещё (N)"
- При клике на "Ещё" раскрывается полный список тренировок дня
...
├─────────────────────────────────────────────────────────────────────────────────────┤
│ 10:00         -        09:00      10:00        -        11:00       10:00          │
│ Yoga          -        Pilates    CrossFit     -        Yoga        HIIT           │
│ Анна                   Елена      Михаил                Анна        Дмитрий        │
│                                                                                      │
│ 18:00         -        18:00      19:00        -         -           -             │
...
**UI ячейки дня с раскрытым списком:**
